...
\usepackage{fontspec}
\newfontfamily{\coverpagetitlefont}{QTAgateType.otf}
\usepackage{fontspec}
...
\includegraphics[width=\paperwidth, keepaspectratio]{img/bridge.jpeg}};
...
Preferences After COVID-19 Study of the UK Tourism Development}}};
}
\end{scope}
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, breakable, frame hidden, enhanced, sharp corners]}{\end{tcolorbox}}\fi
