...
\node[scope fading=north, inner sep=0pt, outer sep=0pt]{
 \makebox[\textwidth]{\includegraphics[width=\paperwidth]{images/TheGreatWaveoffKanagawa.jpeg}}
};
\end{tikzpicture}
\end{center}
...
\end{frontmatter}
  ...
  \ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, borderline west={3pt}{0pt}{shadecolor}, enhanced, sharp corners, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics{images/TheGreatWaveoffKanagawa.jpeg}
